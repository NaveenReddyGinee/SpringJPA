...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			applicationContext = new ClassPathXmlApplicationContext("com/accenture/resource/jpa_spring1.xml");
	...
	public static void deleteEmployee(EmployeeDAO daoimpl) {
		...
		try {
			...
			if (employeeEntityBean == null) {
				...
				System.out.println("Employee Deleted successfully with employeeId: " + employeeEntityBean.getId());
			}
