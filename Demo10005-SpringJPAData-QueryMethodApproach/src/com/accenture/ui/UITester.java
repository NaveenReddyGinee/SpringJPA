...
/*
 * https://docs.spring.io/spring-data/jpa/docs/1.3.0.RELEASE/reference/htmlsingle/#jpa.query-methods.query-creation
 */
...
public class UITester {
	...
	public static void getAllEmployeeDetails1(EmployeeDAO3 daoimpl) {
		...
		try {
			...
			System.out.println(daoimpl.findBySalaryGreaterThanEqual(30000.0));
